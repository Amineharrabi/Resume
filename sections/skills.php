        ...
        <div class="skills-container">
            ...
            <div class="skills-category" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="skill-tags">
                    ...
                    <span class="skill-tag"><i class="fab fa-python"></i>Scikit-learn</span>
                    <span class="skill-tag"><i class="fab fa-python"></i>TensorFlow</span>
                    <span class="skill-tag"><i class="fab fa-python"></i>PyTorch</span>
                    <span class="skill-tag"><i class="fab fa-python"></i>Keras</span>
                    <span class="skill-tag"><i class="fas fa-chart-line"></i>Matplotlib</span>
                    <span class="skill-tag"><i class="fas fa-database"></i>PostGres SQL</span>
                    <span class="skill-tag"><i class="fas fa-server"></i>Flask</span>
                    <span class="skill-tag"><i class="fas fa-server"></i>Django</span>
                    <span class="skill-tag"><i class="fas fa-server"></i>supabase</span>
            ...
            <div class="skills-category" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="skill-tags">
                    ...
                    <span class="skill-tag"><i class="fab fa-microsoft"></i>Azure</span>
                    <span class="skill-tag"><i class="fas fa-database"></i>MySQL</span>
                    <span class="skill-tag"><i class="fas fa-database"></i>PostgreSQL</span>
                    <span class="skill-tag"><i class="fas fa-terminal"></i>Linux</span>
                    <span class="skill-tag"><i class="fas fa-brain"></i>Apache</span>
                </div>
            </div>
        </div>
    </div>
